...
const Contact = () => {
    return (
        ...
        <div className="contact">
            ...
            <p>Heb jij interesse om advertenties op TipsNtricks.games te plaatsen? Stuur dan een mailtje naar  <a href="mailto:info@tipsntricks.games">info@tipsntricks.games</a>.</p>
            ...
            <p>Sappig nieuws is altijd welkom. Heb jij gehoord over een nieuwe update? zit je te broeden op een primeur of heb je een gerucht de ronde horen gaan?
                Stuur dan een bericht naar onze nieuwscrew! <a href="mailto:redactie@tipsntricks.games">redactie@tipsntricks.games</a>.</p>
            <p><strong>Copyright</strong> </p>

            <p>Heb je een vraag over afbeeldingen en tekst in onze berichten? Of kan je niet geloven dat we je afbeelding zonder toestemming hebben gebruikt? Reik dan uit naar: <a href="mailto:redactie@tipsntricks.games">redactie@tipsntricks.games</a>. </p>
            <p><strong>Solliciteren?</strong></p>

            <p>Wij zijn altijd op zoek naar nieuw talent! Heb jij flink wat in je mars? <Link exact to="/vacature">Check dan hier onze vacatures </Link></p>
            <p><strong>Algemene vragen</strong></p>

            <p>Kom je er gewoon niet uit en weet je niet meer wat je moet doen? <a href="mailto:j.hasselbach@tipsntricks.games">j.hasselbach@tipsntricks.games</a>.</p>
            ...
            <ul>
                ...
                <li><a href="https://www.discord.gg" target="_blank" rel="noopener noreferrer"><FaDiscord/> Discord</a></li>
