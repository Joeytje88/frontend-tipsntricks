...
const Vacature = () =>{
    return (
        ...
        <p>Uitleggen hoe een game werkt, kan natuurlijk nog makkelijker middels streams. Vind jij het leuk om onze community te helpen wanneer
            zij ergens vastlopen? Stuur dan snel een mailtje naar <a href="mailto:j.hasselbach@tipsntricks.games">j.hasselbach@tipsntricks.games</a>.</p>

        <h3>Video editors</h3>
        <p>Vind je het leuk om video's te maken? En ben jij de Spielberg-in-wording van de video editors?
            Stuur dan snel een mailtje naar <a href="mailto:j.hasselbach@tipsntricks.games">j.hasselbach@tipsntricks.games</a></p>

            <p>Heb je tips of ideeën? Of denk je een andere rol bij ons te kunnen en willen vertolken? <a href="mailto:j.hasselbach@tipsntricks.games">Laat het ons vooral weten!</a></p>
        </div>
            </>
)
}
